6#This code will check if each cell is bigger than all its neighbours and print out all these cells with the coordinates of the cell
...
#A functions for a single cell matrix, just printing a message and the coordinates 
